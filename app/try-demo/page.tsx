    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex flex-col items-center justify-center p-8">
      ...
      <div className="text-center mb-12 max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Voice AI your customers will love.
        </h1>
        <p className="text-xl text-gray-600">
          Experience the power of conversational AI with our interactive demo
        </p>
      </div>
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-center text-lg mt-4">
              ...
              <br />
              <br />
              Sign up for early access and be the first to experience our revolutionary voice AI technology!
            </DialogDescription>
          </DialogHeader>
